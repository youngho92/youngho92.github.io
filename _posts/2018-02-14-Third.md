...
<b>Linear Regression on Alcohol Consumption</b>
...
Then, in order to find the optimal model for classification, I conducted grid search on KNN, Logistic Regression, Support Vector Machine, and Random Forest as follow.
<br>
<b>Grid Search</b>
<img src="/images/Mcnulty/part1_grid.png" width="500">


It turned out that Random Forest beat all the other models in classification measures including precision, recall, and F1 score. The detailed measures for each category is as follow.
<b>Random Forest Classification Report</b>
<img src="/images/Mcnulty/part1_report.png" width="350">
<br>

<br>
<ul>Linear Regression VS Random Forest in Feature Importance</ul>
<img src="/images/Mcnulty/part1_feature.png" width="500">
<br>
