...
As the above graph shows, the MSE of the ridge regularization for wider receiver achieves its minimum when the degree is 3 and the alpha parameter becomes 10<sup>-6</sup>.
